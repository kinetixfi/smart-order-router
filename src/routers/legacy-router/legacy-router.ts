...
import { ChainId, Currency, Token, TradeType } from '@kinetix/sdk-core';
import { FeeAmount, MethodParameters, Pool, Route } from '@kinetix/v3-sdk';
...
import { ITokenProvider, USDT_KAVA } from '../../providers/token-provider';
...
export class LegacyRouter {
  ...
  public async routeExactOut(
    ...
    return {
      ...
      estimatedGasUsedUSD: CurrencyAmount.fromFractionalAmount(USDT_KAVA, 0, 1),
      gasPriceWei: BigNumber.from(0),
      trade,
      methodParameters: swapConfig
        ? {
      ...
      return new V3RouteWithValidQuote({
        ...
        gasModel: {
          estimateGasCost: () => ({
            ...
            gasCostInUSD: CurrencyAmount.fromRawAmount(USDT_KAVA, 0),
